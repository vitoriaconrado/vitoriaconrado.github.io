...
const projectDetails = {
  ...
  web: ["Web experiment · ongoing", "In construction", "A quiet digital notebook for collecting observations, textures, and questions from everyday walks.", "#", "Project notes coming soon ↗"],
  ...
  cells: ["Writings · ongoing", "In construction", "Short essays and working notes on public health, biosecurity, technology, and AI.", "#", "Writing archive coming soon ↗"],
};
